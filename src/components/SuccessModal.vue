...
.paystack-button {
    border: none;
    background-color: linear-gradient(90deg, rgba(1,76,41,1) 0%, rgba(35,240,11,1) 100%);
    padding: 10px 20px;
    border: 2px solid linear-gradient(90deg, rgba(1,76,41,1) 0%, rgba(35,240,11,1) 100%);
    font-size: 1.7rem;
    color: white;
}
